...
public class DerpAdapter extends RecyclerView.Adapter<DerpAdapter.DerpHolder> {
    ...
    class DerpHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if(v.getTag().toString().equals("remove")) {
                listData.remove(getAdapterPosition()); // getAdapterPosition to get position of the button clicked
                notifyItemRemoved(getAdapterPosition()); //remove item from arraylist
            }
        }
    }
}